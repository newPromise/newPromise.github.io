...
<video src="由目录搜索想到的多叉树向二叉树的转换/menus.mp4" controls="controls" style="max-width: 100%; display: block; margin-left: auto; margin-right: auto;">
...
![](由目录搜索想到的多叉树向二叉树的转换/二叉查找树结果.png)
...
![](由目录搜索想到的多叉树向二叉树的转换/多叉树转二叉树示意图.png)
